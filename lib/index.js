...
exports.default = function (request) {
    ...
    var logName = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'super-log';
    var curlName = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'super-curl';

    var debugLog = _debug(logName);
    var debugCurl = _debug(curlName);
...
var log = function log(debug, value, logger) {
    if (logger) {
        logger.apply(value);
    }
};